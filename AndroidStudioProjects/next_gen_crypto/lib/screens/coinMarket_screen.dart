...
class CoinMarketScreen extends StatefulWidget {
  CoinMarketScreen({Key key, this.title}) : super(key: key);
  final String title;
  ...
  void initData(int size) {
    for (int i = 0; i < size; i++) {
      userInfo.add(UserInfo(
          "User_$i", i % 3 == 0, '+0019', '2019-01-01', 'N/A'));
    }
  }
...
class UserInfo {
  ...
  @override toString() => ['Name: $name','Status: $status','Phone: $phone','RegisterDate: $registerDate','TerminationDate: $terminationDate',].toString();
