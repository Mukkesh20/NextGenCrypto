...
class _LoadingScreenState extends State<LoadingScreen> {
  ...
  void getCoinMarketData() async {
    var weatherData = await coinMarketModel.getCoinMarketData('inr');
    Navigator.push(context, MaterialPageRoute(builder: (context)=>CoinMarketScreen(title: 'NextGenCrypto'),),);
  }
